<<<<<<<< HEAD:v1_20_R3/src/main/java/be/isach/ultracosmetics/v1_20_R3/customentities/CustomSlime.java
...
>>>>>>>> upstream/master:v1_20_R4/src/main/java/be/isach/ultracosmetics/v1_20_R4/customentities/CustomSlime.java
...
public class CustomSlime extends Slime implements EntityBase {
    ...
    public Component getName() {
        return CustomEntities.toComponent(Language.getInstance().getOrDefault("entity.minecraft.slime"));
    }
